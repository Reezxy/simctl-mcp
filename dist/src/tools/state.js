import { registerScreen, markScreenTested, addEdge, addBug, getGraph, getStats, hasVisitedTooManyTimes, resetGraph, } from "../engine/screen-graph.js";
import { generateReport } from "../engine/report-generator.js";
import { toolError, toolOk } from "../types.js";
export const stateTools = [
    {
        name: "register_screen",
        description: "Registers the current screen in the test session's screen graph. " +
        ...
        inputSchema: {
            ...
            properties: {
                name: {
                    type: "string",
                    description: "Short, unique screen identifier, e.g. 'HomeScreen', 'CheckoutForm'.",
                },
                description: {
                    type: "string",
    ...
    },
    {
        ...
        description: "Records the test outcome for a screen. " +
    ...
    },
    {
        ...
        description: "Records a navigation transition in the screen graph: which screen you came from, " +
        ...
        inputSchema: {
            ...
            properties: {
                ...
                action: {
                    type: "string",
                    description: "What triggered the navigation, e.g. 'tap Sign In', 'swipe back'.",
                },
            },
    ...
    },
    {
        ...
        description: "Returns the full directed graph of discovered screens and navigation paths. " +
    ...
    {
        name: "add_bug",
        description: "Records a bug found during testing. Call this whenever you observe unexpected behaviour: " +
        ...
        inputSchema: {
            ...
            properties: {
                ...
                description: {
                    type: "string",
                    description: "Steps to reproduce and what was expected vs actual.",
                },
                screen: {
                    type: "string",
        ...
        handler: async (args) => {
            const bug = addBug(args["severity"], args["title"], args["description"], args["screen"], args["screenshot_path"], args["log_excerpt"]);
            return toolOk(bug);
        },
    },
    {
        name: "get_test_report",
        description: "Generates the final test report for the current session. " +
    ...
    },
    {
        ...
        description: "Clears all screen graph data, bugs, and stats to start a fresh test session. " +
